...
// function Salam(name:number,name1:number){
// return name + name1
// }
// Salam(5,7)
...
// const Salmans =  (name:number,name1:number) => {
...
// let Name:unknown = "Asad"
// console.log((Name as string).length)
// console.log(<string> Name)

// // tupples

// let tupples:[number,boolean,] = [1,true]
// console.log(tupples)


// // rest parameter

// function Rest(first:string,...second:string[]){
...
// let address:{add:number,add1:number} = {
//    add:1,
//    add1:12
